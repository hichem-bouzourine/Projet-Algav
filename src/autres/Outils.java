...
public class Outils {
	 ...
	 */
	/**
	 * Calcule et sauvegarde les temps d'exécution de l'ajout d'une clé à un tas min
	...
	/**
	 * Calcule et sauvegarde les temps d'exécution de construction sur un tas min
	 * utilisant un arbre.
	 */
	...
	/**
	 * Calcule et sauvegarde les temps d'exécution de l'union de deux tas min
	 * utilisant des arbres.
	 */
	...
	/**
	 * ! 10% dernier : Calcule et sauvegarde les temps d'exécution de l'ajout d'une
	 * clé à un tas min utilisant un tableau.
	 */
	...
	/**
	 * ! 10% dernier : Calcule et sauvegarde les temps d'exécution de la suppression
	 * de la clé minimum dans un tas min utilisant un tableau.
	 */
	...
	/**
	 * Calcule et sauvegarde les temps d'exécution de la construction d'une file
	 * binomiale.
	 */
	...
	/**
	 * Calcule et sauvegarde les temps d'exécution de l'union de deux files
	 * binomiales.
	 */
	...
	public static void AjoutFileBinomiale() {
		...
		for (int i = 1; i <= nb; i++) {
			for (int j = 0; j < tailles.length; j++) {
				...
				for (int k = 0; k < cles.size(); k++) {
					ICle c = cles.get(k);
					// rajouter 80 % du dataset dans une clé et calculer le temps nécessaire pour
					// les 20 %
					if (k < cles.size() - (cles.size() / 20))
	...
	/**
	 * ! 10% dernier : Calcule et sauvegarde les temps d'exécution de la suppression
	 * de la clé minimum dans une file binomiale.
	 */
